...
export function Icon({ name, size = 18 }) {
  const paths = {
    ...
    spark: <path d="M12 2v4M12 18v4M2 12h4M18 12h4M12 8a4 4 0 1 0 0 8 4 4 0 0 0 0-8z" />,
  };
  return <svg viewBox="0 0 24 24" width={size} height={size} aria-hidden="true" {...base}>{paths[name] || paths.circle}</svg>;
}
